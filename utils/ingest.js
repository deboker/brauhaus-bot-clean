...
const requiredEnv = [
  ...
  "VITE_SUPABASE_URL_LC_CHATBOT_BRAUHAUS",
  "VITE_SUPABASE_API_KEY_BRAUHAUS"
]
...
async function main() {
  ...
  const client = createClient(
    process.env.VITE_SUPABASE_URL_LC_CHATBOT_BRAUHAUS,
    process.env.VITE_SUPABASE_API_KEY_BRAUHAUS
  )
